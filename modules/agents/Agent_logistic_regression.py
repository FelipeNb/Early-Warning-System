...
#import procname
#procname.setprocname(str(sys.argv[1])+'Agent_logistic_regression')

ipAddress = '127.0.0.1'
port = int(sys.argv[1])

urls = (
    '/Agent_logistic_regression', 'Main',
)
...
i = time.time()
classifier, accuracy = func_Logistic_Regression(x_train,y_train,x_test,y_test,plot=False)
f = time.time()
# print('Logistic_Regression' + str(f-i))
############  INIT VARIABLES  ##############
