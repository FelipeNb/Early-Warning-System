...
#import procname
#procname.setprocname(str(sys.argv[1])+'Agent_svm')

ipAddress = '127.0.0.1'
port = int(sys.argv[1])#8886
...
i = time.time()
classifier, accuracy = func_SVM(x_train,y_train,x_test,y_test,plot=False, type='sigmoid')
f = time.time()
# print('svm' + str(f-i))
############  INIT VARIABLES  ##############
